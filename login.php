...
<div ng-app ng-init="checked = false">
		...
		<form class="form-signin" action="vhod.php" method="post" name="form">
	      <label for="login">Логин</label>
          <input class="form-styling" type="text" name="login" placeholder=""/>
          <label for="password">Пароль</label>
          <input class="form-styling" type="text" name="password" placeholder=""/>
          <input type="checkbox" id="checkbox"/>
          <label for="checkbox" ><span class="ui"></span>Держите меня в системе</label>
          <div class="btn-animate">
          <a class="btn-signin"><input type="send" value="Войти"></a>
</div>
...
if(isset($send)){
$result = mysqli_query($connect, "SELECT * FROM user WHERE login = '$login' AND password = '$password'") or die ( "Error : ".mysqli_error() ); 
...
if($name=='ks'){
echo"<a href='ingex.php'>предметная база</a>";
	}
else{
echo"<a href='ingex.php'>главная станица</a>";}
	}
else{
